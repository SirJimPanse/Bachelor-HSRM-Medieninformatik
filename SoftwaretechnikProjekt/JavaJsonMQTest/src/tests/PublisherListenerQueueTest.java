...
public class PublisherListenerQueueTest {
	...
	public void setUp(){
		...
		topicName= "factory";
		publisher = new OurPublisher(topicName,ConnectionType.QUEUE);
		listener  = new OurListener(topicName, ConnectionType.QUEUE);
