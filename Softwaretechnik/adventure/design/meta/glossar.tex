\svnid{$Id: glossar.tex 180 2012-05-24 15:26:04Z dgens001 $}
...
\newglossaryentry{Blickrichtung}{
	name={Blickrichtung},
	plural={Blickrichtungungen},
	description={Bezeichnet die Richtung des \gls{Spieler}s, in die er gerade schaut. Der 
		\gls{Spieler} kann sich drehen und die Blickrichtung dadurch ändern}
}
...
\newglossaryentry{Anzeige}{
	name={Anzeige},
	plural={Anzeigen},
	description={Der gesamte, darzustellende Bereich der Anwendung. Jeweils entweder durch den \gls{Menuemodus} 
		oder den \gls{Aktivitaetsbereich} ausgefüllt.}
}
...
\newglossaryentry{Infobereich}{
	name={Infobereich},
	description={Einer der vier \glspl{Aktivitaetsbereich} des Spiels \gls{Ingame}. Hier wird das \gls{Inventar}
