...
def display():
    ...
    triList = [transPoints[0], transPoints[1], transPoints[2],
               transPoints[1], transPoints[2], transPoints[3],
               transPoints[2], transPoints[3], transPoints[4],
               transPoints[3], transPoints[4], transPoints[5],
               transPoints[4], transPoints[5], transPoints[6],
               transPoints[5], transPoints[6], transPoints[7],
               transPoints[5], transPoints[7], transPoints[8],
               transPoints[8], transPoints[7], transPoints[9],
               transPoints[7], transPoints[9], transPoints[10],
               transPoints[9], transPoints[10], transPoints[11],
               transPoints[10], transPoints[11], transPoints[12],
               transPoints[11], transPoints[12], transPoints[13]]
    for i in triList:
        glVertex2f(i[0], i[1])
    glEnd()
    glFlush()
